"""Models for request validation in the frontend API."""
...
class PodcastFeedRequest(BaseModel):
    ...
    target_path: str  # Required for routing
    feed_url: str
...
class UserEmailRequest(BaseModel):
    """Request model for user email summaries"""
    target_path: str  # Required for routing
    user_id: str

class EpisodeEmailRequest(BaseModel):
    """Request model for episode email summaries"""
    target_path: str  # Required for routing
    user_id: str
    episode_id: str